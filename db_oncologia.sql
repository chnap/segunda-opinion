...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2026 at 07:22 PM
...
CREATE TABLE `cases` (
  ...
  `clinical_question` text DEFAULT NULL,
...
CREATE TABLE `case_checklists` (
  ...
  `medical_report` varchar(50) DEFAULT 'MISSING',
  `pathology` varchar(50) DEFAULT 'MISSING',
  `imaging` varchar(50) DEFAULT 'MISSING',
  `treatment` varchar(50) DEFAULT 'MISSING',
  `labs` varchar(50) DEFAULT 'MISSING',
  `genomics` varchar(50) DEFAULT 'NOT_REQUIRED',
  `medication` varchar(50) DEFAULT 'MISSING',
  `clinical_question` varchar(50) DEFAULT 'PRESENT'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `clinical_cases` (
  ...
  `email` varchar(150) NOT NULL,
  `phone` varchar(50) NOT NULL,
  `patient_type` varchar(50) DEFAULT 'self',
  `diagnosis` text NOT NULL,
  `reason` text NOT NULL,
  `clinical_question` text NOT NULL,
  `status` varchar(50) DEFAULT 'NEW_REQUEST',
  `dricloud_patient_id` varchar(50) DEFAULT NULL,
...
INSERT INTO `clinical_cases` (`id`, `public_reference`, `patient_name`, `email`, `phone`, `patient_type`, `diagnosis`, `reason`, `clinical_question`, `status`, `dricloud_patient_id`, `dricloud_form_sent_at`, `dricloud_form_completed_at`, `sms_status`, `sms_sent_at`, `created_at`, `updated_at`) VALUES
('CASE-42994', 'REF-83476', 'Nacho Ortega', 'nachonon9@gmail.com', '605629341', 'self', 'ss', 's', 's', 'NEW_REQUEST', NULL, NULL, NULL, NULL, NULL, '2026-08-13 09:47:17', '2026-08-13 09:47:17'),
('CASE-DEMO-1', 'REF-84920', 'Carmen Gómez Ruiz', 'carmen.gomez@example.com', '+34600112233', 'self', 'Adenocarcinoma de mama estadio II', 'Buscar segunda opinión sobre pauta de quimioterapia adyuvante.', '¿Es recomendable añadir inmunoterapia o mantener tratamiento estándar?', 'NEW_REQUEST', NULL, NULL, NULL, NULL, NULL, '2026-08-13 09:38:59', '2026-08-13 09:38:59');
